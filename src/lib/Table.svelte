...
>
    ...
    {#each names as user (user.id)}
      <div class="flex items-center justify-between py-3">
        ...
        <div class="flex space-x-2">
          <button
            on:click={() => showUpdateForm(user.id, user.name, user.email)}
          >
  ...
  {#if updateId !== null}
    <div
      class="mt-10 pt-6 w-full max-w-xl p-5 mx-auto rounded-lg shadow-xl dark:bg-white/10 bg-white/30 ring-1 ring-gray-900/5 backdrop-blur-lg"
    >
