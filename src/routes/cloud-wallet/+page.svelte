...
<div class="flex flex-wrap justify-center mt-3 space-x-14">
  <div
    class="w-full md:w-2/5 max-w-lg p-4 rounded-lg shadow-xl dark:bg-white/10 bg-white/30 ring-1 ring-gray-900/5 backdrop-blur-lg"
  >
    ...
    {#if form?.success}
      <p class="pt-2 text-center text-green-500">
        Login Successful. Your balance is {form?.balance}
      </p>
    {/if}
  </div>
  ...
  >
    ...
    {#if form?.success}
      <p class="text-center text-green-500">
        Payment Successful. Here is your <a
          href={form?.payment}
